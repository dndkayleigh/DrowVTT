...
test('shared VTT UI package exposes tactical interaction modules', () => {
  ...
  assert.match(renderOssVttShell(), /value="single_fast"/);
  assert.match(renderOssVttShell(), /value="single_tactical"/);
  assert.match(renderOssVttShell(), /value="group_tactical"/);
  ...
  assert.match(renderOssVttShell(), /value="controller_supervisor_scripted" selected/);
