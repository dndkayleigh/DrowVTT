...
test('shared VTT UI package exposes tactical interaction modules', () => {
  ...
  assert.doesNotMatch(renderOssVttShell(), /value="llm_supervisor_single"/);
  assert.doesNotMatch(renderOssVttShell(), /value="llm_supervisor_group"/);
  assert.match(renderOssVttShell(), /value="controller_scripted"/);
  assert.match(renderOssVttShell(), /value="controller_utility"/);
  assert.match(renderOssVttShell(), /value="controller_supervised_utility"/);
  assert.match(renderOssVttShell(), /id="aiActivationScope"/);
  assert.match(renderOssVttShell(), /id="selBattlefieldJob"/);
  assert.match(renderOssVttShell(), /id="selBehaviorPreset"/);
  assert.match(renderOssVttShell(), /id="selSpecialObjective"/);
  assert.match(renderOssVttShell(), /id="selProtectedAsset"/);
  assert.match(renderOssVttShell(), /id="selTacticsNotes"/);
  assert.match(renderOssVttShell(), /id="tokenAiInterpretationSummary"/);
  assert.match(renderOssVttShell(), /id="turnTacticsAdvanced"/);
  assert.match(renderOssVttShell(), /id="selAuthoredEncounterRole"/);
  assert.match(renderOssVttShell(), /id="selControllerRoleOverride"/);
  assert.match(renderOssVttShell(), /id="selMappedControllerRole"/);
